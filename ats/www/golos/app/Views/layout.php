...
<body>
	...
	<main class="d-flex flex-nowrap">
		<div class="d-flex flex-column p-0 text-bg-dark" style="position:fixed;height:100%;width:10em;">
			<ul class="nav dnav-pills flex-column mb-auto">
				...
				<li id="sidebar-pmux" class="nav-link link text-white">PMUX</li>
		...
		<div id="content" class="container-fluid p-2" style="margin-left:10em;">
			...
			<div id="page-pmux" class="d-none"><?php echo view('pmux'); ?></div>
	...
	<script>
		...
		function sideBarSetItem(item) {
			...
			$('#sidebar-pmux').removeClass('bg-primary');
			...
			$('#page-pmux').removeClass('d-block').addClass('d-none');
		...
		window.addEventListener('DOMContentLoaded', (event) => {
			// Toast
			toastContainer = new XuToastContainer(null, {
			...
			$('#sidebar-pmux').on('click', function() {
				sideBarSetItem('pmux');
			});
