		...
		<div class="modal d-flex align-items-center">
		  <div class="modal-dialog shadow">
		    <div class="modal-content border-0">
				  <form id="login-form">
			      <div class="modal-header border-0 px-3 py-2 bg-primary text-light">
			        <h6 class="modal-title m-0">WebAster 2.0 &mdash; авторизация</h6>
			      </div>
			      ...
			      <div class="modal-footer px-3 pt-0 pb-3 border-0 d-block text-center">
			        <button id="login-button" type="submit" class="btn btn-sm btn-primary" disabled>Вход</button>
			      </div>
				  </form>
		    </div>
		  </div>
